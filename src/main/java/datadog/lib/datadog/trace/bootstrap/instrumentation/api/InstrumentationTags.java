...
public class InstrumentationTags {
    ...
    public static final String ELASTICSEARCH_REQUEST_SEARCH_TYPES = "elasticsearch.request.search.types";
    public static final String ELASTICSEARCH_REQUEST_WRITE_TYPE = "elasticsearch.request.write.type";
    public static final String ELASTICSEARCH_REQUEST_WRITE_ROUTING = "elasticsearch.request.write.routing";
    public static final String ELASTICSEARCH_REQUEST_WRITE_VERSION = "elasticsearch.request.write.version";
    ...
    public static final String ELASTICSEARCH_SHARD_BROADCAST_TOTAL = "elasticsearch.shard.broadcast.total";
    public static final String ELASTICSEARCH_SHARD_BROADCAST_SUCCESSFUL = "elasticsearch.shard.broadcast.successful";
    public static final String ELASTICSEARCH_SHARD_BROADCAST_FAILED = "elasticsearch.shard.broadcast.failed";
    ...
    public static final String ELASTICSEARCH_SHARD_REPLICATION_TOTAL = "elasticsearch.shard.replication.total";
    public static final String ELASTICSEARCH_SHARD_REPLICATION_FAILED = "elasticsearch.shard.replication.failed";
